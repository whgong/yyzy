...
COMMENT ON PROCEDURE YYZY.P_YYZY_SDPFGX7DPH( INTEGER,integer ) IS '7要素锁定配方更新 单牌号角色';
...
COMMENT ON PROCEDURE YYZY.P_YYZY_SDPFGX7() IS '7要素锁定配方更新';
