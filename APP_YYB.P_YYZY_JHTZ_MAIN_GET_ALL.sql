...
*/
    ...
    --更新提前领料数据
    delete from YYZY.T_YYZY_YSCJH_TQLLL where jhny = (MIN_KSRQ+2 day) - (day(MIN_KSRQ+2 day)-1) day - 1 month;
    ...
    --历史配方、历史计划 2013-12-31重构历史配方模块
    call YYZY.P_YYZY_LSPF(MIN_KSRQ+1 DAY);
